(function($) {
    Ratchet.AbstractDynamicGadget = Ratchet.Gadget.extend(
    {
        ...
        doRender: function(context, model, callback)
        {
            ...
            self.beforePrepareModel(context, model, function() {
                ...
                self.loadDynamicConfiguration(context, model, function() {
                    ...
                    // allows for any preparation of the model that should automatically occur after the dynamic config is loaded
                    self.afterLoadDynamicConfig(context, model, function() {
        ...
        afterLoadDynamicConfig: function(el, model, callback)
        {
            callback();
        },
