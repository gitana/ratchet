define(["ratchet/ratchet", "gitana", "./AbstractGitanaAuthenticator"], function(Ratchet, Gitana, AbstractGitanaAuthenticator) {

    return Ratchet.Authenticators.GitanaImplicitFlowAuthenticator = AbstractGitanaAuthenticator.extend({
