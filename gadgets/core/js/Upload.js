Ratchet.Gadgets.Upload = Ratchet.AbstractDynamicGadget.extend({

    TEMPLATE: "core/gadgets/upload",
    ...
    afterSwap: function(el, config, originalContext)
    {
        ...
        // store branch
        config["branch"] = Spaces.stackBranch(originalContext.ratchet());
...
Ratchet.GadgetRegistry.register("upload", Ratchet.Gadgets.Upload);
